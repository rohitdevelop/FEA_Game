  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-green-50 relative px-4 transition-all duration-500">
      ...
      >
        ...
        <h2 className='text-red-600 text-2xl mb-6 font-bold'>(100 Points)</h2>
        <p className="text-xl font-medium mb-4">What do you say when you meet someone for the first time?</p>
