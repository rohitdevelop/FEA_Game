...
const Easyca3p200 = () => {
  ...
  const correctAnswer = "good morning";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-green-50 relative px-4 transition-all duration-500">
      ...
      >
        <h1 className="text-3xl font-bold text-blue-700">
          🙋‍♂️ (Greetings & Good Manners)
        </h1>
        <h2 className='text-red-600 text-2xl mb-6 font-bold'>(200 Points)</h2>
        <p className="text-xl font-medium mb-4">What do you say in the morning to greet someone politely?</p>
