...
const Easyca2p400 = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-blue-50 relative px-4 transition-all duration-500">
     ...
     <h2 className='text-red-500 text-2xl mb-6 font-bold'>(400 Points)</h2>
        <p className="text-xl font-medium mb-4">He ___ understand five languages, but he ___ write in only two.</p>
