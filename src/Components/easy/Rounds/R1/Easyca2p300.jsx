...
const Easyca2p300 = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-blue-50 relative px-4 transition-all duration-500">
     ...
     <h2 className='text-red-500 text-2xl mb-6 font-bold'>(300 Points)</h2>
        <p className="text-xl font-medium mb-4">You ___ ride a bike if you don't know how to balance</p>
