...
const Round1 = () => { 
  const categories = ["Alphabet & Spellings", "Abilities & Permissions", "Greetings & Good Manners"];
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-6 relative z-10">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg">Test Your Knowledge</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {categories.map((cat, catIndex) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl blur opacity-75 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative h-20 flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600 text-white text-lg font-bold rounded-2xl shadow-xl border border-white/10 backdrop-blur-sm">
                ...
                return (
                  ...
                  >
                    ...
                    {isHovered && !isDisabled && (
                      <div className={`absolute inset-0 bg-${style.glow} rounded-3xl blur-xl opacity-30 transition-opacity duration-300`}></div>
                    )}
                    ...
                    >
                      ...
                      {!isDisabled && isHovered && (
                        <>
                          ...
                          <div className="absolute bottom-2 right-2 w-2 h-2 bg-white/60 rounded-full animate-ping" style={{ animationDelay: '0.5s' }}></div>
                          <div className="absolute top-1/2 left-1/4 w-1 h-1 bg-white/60 rounded-full animate-ping" style={{ animationDelay: '1s' }}></div>
                        </>
                      )}
                    </button>
                  </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-4 px-8 py-4 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20">
            ...
            <div className="text-white">
              <div className="font-semibold">Choose a category and point value</div>
              <div className="text-sm text-gray-300">Click the checkbox to mark questions as used</div>
            </div>
          </div>
        </div>
      </div>
